---
name: next-steps
description: Post-loop guidance — APIs, MCPs, GitHub push, advanced skills, custom skill creation
---
...
### 2. Level up your research (add API keys)
...
### 3. Connect your tools (add MCP servers)
...
"Questions about any of these? Or ready to run another skill?"
